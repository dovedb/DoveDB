# How to Contribute to DoveDB

We'd love your help!

DoveDB is [Apache 2.0 licensed](./LICENSE) and accepts contributions via GitHub
...
* Problem - what in DoveDB blocks you from solving the requirement?
...
make sure the year is current and the copyright says "The DoveDB Authors".

```
// Copyright (c) 2022 The DoveDB Authors.
//
...
Note that **every commit in the pull request must be signed**. DoveDB
