...
DoveDB, inspired by [Otif](https://favyen.com/otif.pdf) and [SRTracker](https://github.com/dovedb/DoveDB/blob/main/technical%20report.pdf), is a systematic data management platform with high usability and low latency created by [DILAB](https://dilab-zju.github.io/).
